(function ($) {
  ...
  if ($(".pricing-two-tab").length) {
    $(".pricing-two-tab .pricing-two-tab-btns .p-tab-btn").on(
      "click",
      function (e) {
        e.preventDefault();
        ...
        if ($(target).hasClass("actve-tab")) {
          ...
          $(".pricing-two-tab .pricing-two-tab-btns .p-tab-btn").removeClass(
            "active-btn"
          );
          $(this).addClass("active-btn");
          $(".pricing-two-tab .p-tabs-content .p-tab").removeClass(
            "active-tab"
          );
  ...
  if ($(".gallery-two-tabs-box").length) {
    $(".gallery-two-tabs-box .gallery-two-tab-btns .p-tab-btn").on(
      "click",
      function (e) {
        e.preventDefault();
        var target = $($(this).attr("data-tab"));
        ...
        if ($(target).hasClass("actve-tab")) {
          ...
          $(
            ".gallery-two-tabs-box .gallery-two-tab-btns .p-tab-btn"
          ).removeClass("active-btn");
          $(this).addClass("active-btn");
          $(".gallery-two-tabs-box .p-tabs-content .p-tab").removeClass(
            "active-tab"
          );
          $(target).addClass("active-tab");
        }
        ...
        $(this)
          ...
          .on("click", function () {
            ...
            if (!parent.hasClass("active")) {
              ...
              parent.find(".accrodion-content").slideUp();
            }
          });
      });
    });
